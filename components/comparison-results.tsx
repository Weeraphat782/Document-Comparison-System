...
import { FileText, FileCheck, AlertTriangle, XCircle, CheckCircle2, ChevronDown, ChevronUp } from "lucide-react"
      ...
      {criticalChecksResults.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">Verification results for all critical requirements</p>
          </CardHeader>
          <CardContent>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <Badge
                          ...
                          className={
                            check.status === "PASS" ? "bg-green-600" : check.status === "WARNING" ? "bg-yellow-500" : ""
                          }
                        >
                          {check.status}
                        </Badge>
          ...
          <CardContent>
            <div className="space-y-3">
              {allCritical.map((item, idx) => (
                <div
                  key={idx}
                  className="flex gap-3 p-4 bg-red-50 dark:bg-red-950/20 rounded-lg border border-red-200 dark:border-red-900"
                >
          ...
          <CardContent>
            <div className="space-y-3">
              {allWarnings.map((item, idx) => (
                <div
                  key={idx}
                  className="flex gap-3 p-4 bg-yellow-50 dark:bg-yellow-950/20 rounded-lg border border-yellow-200 dark:border-yellow-900"
                >
        ...
        <div>
          ...
          <div className="space-y-3">
            {criticalIssues.map((issue, idx) => (
              <div
                key={idx}
                className="flex gap-4 p-4 bg-red-50 dark:bg-red-950/20 rounded-lg border border-red-200 dark:border-red-900"
              >
        ...
        <div>
          ...
          <div className="space-y-3">
            {warnings.map((warning, idx) => (
              <div
                key={idx}
                className="flex gap-4 p-4 bg-yellow-50 dark:bg-yellow-950/20 rounded-lg border border-yellow-200 dark:border-yellow-900"
              >
